...
public abstract class AplicacaoSyncAdapter extends AbstractThreadedSyncAdapter{
	...
	protected void sincronizaPrecoDiarioCliente(Context contexto, boolean forcaAtualizacao, boolean delete) {
		PrecoDiarioClienteSincronismo sincSrv = new PrecoDiarioClienteSincronismo();
	...
	protected void sincronizaOportunidadeInteresseCliente(Context contexto, boolean forcaAtualizacao, boolean delete) {
		OportunidadeInteresseClienteSincronismo sincSrv = new OportunidadeInteresseClienteSincronismo();
		
    	sincSrv.sincroniza(getContext(),true, delete, true);
    	
	}
	
	protected void sincronizaCompartilhamentoProduto(Context contexto, boolean forcaAtualizacao, boolean delete) {
		CompartilhamentoProdutoSincronismo sincSrv = new CompartilhamentoProdutoSincronismo();
	...
	/*
	protected void sincronizaLocalizacao(Context contexto, boolean forcaAtualizacao, boolean delete) {
		LocalizacaoSincronismo sincSrv = new LocalizacaoSincronismo();
		
    	sincSrv.sincroniza(getContext(),true, delete, true);
    	
	}
	
	protected void sincronizaAcaoCliente(Context contexto, boolean forcaAtualizacao, boolean delete) {
		AcaoClienteSincronismo sincSrv = new AcaoClienteSincronismo();
		
    	sincSrv.sincroniza(getContext(),true, delete, true);
    	
	}
	
	protected void sincronizaMensagem(Context contexto, boolean forcaAtualizacao, boolean delete) {
		MensagemSincronismo sincSrv = new MensagemSincronismo();
