...
public class SerieTreinoListEdicaoAdapter extends SerieTreinoListEdicaoAdapterBase {
	...
	protected void montaItemLista(int posicao, SerieTreino item, View saida) {
        ...
        if (dataStr1==null) {
        	periodoStr = "Ainda não teve execução";
        	...
        	periodoStr = "De " + dataStr + " até " + dataUlt ;
		...
		setText(saida,item.getListaItemSerie_Possui().size() + " exercícios",R.id.txtQtdeExercicio,"R.id.txtQtdeExercicio");
	}
