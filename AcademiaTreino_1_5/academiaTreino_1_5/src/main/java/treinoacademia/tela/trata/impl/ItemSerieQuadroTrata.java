...
// Foi alterado, não sei se continua funcionando
public class ItemSerieQuadroTrata extends ItemSerieQuadroTrataBase implements OnItemSelectedListener {
	...
	private void carregaUltimasExecucoes() {
		...
		// 2- Somente dentro da tela se sabe melhor o que vai ser necessário
		...
		List<ExecucaoItemSerie> listaExecucaoSerie = execucaoSrv.UltimasExecucoesUsuarioExercicio(getContext());
